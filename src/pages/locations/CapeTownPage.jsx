...
const CapeTownPage = () => {
    useEffect(() => {
        ...
        // Update page title
        document.title = "Web Design Cape Town | Website Designer in CBD, Sea Point, Camps Bay | Inkspire Digital";
        
        // Update meta description
        let metaDesc = document.querySelector('meta[name="description"]');
        if (metaDesc) {
            metaDesc.setAttribute('content', 'Professional web design in Cape Town. Websites for businesses in CBD, Sea Point, Camps Bay, Rondebosch, Claremont, Constantia, Table View, and all Cape Town areas. Starting from R1,499. Get a free quote today!');
        } else {
            metaDesc = document.createElement('meta');
            metaDesc.name = 'description';
            metaDesc.content = 'Professional web design in Cape Town. Websites for businesses in CBD, Sea Point, Camps Bay, Rondebosch, Claremont, Constantia, Table View, and all Cape Town areas. Starting from R1,499. Get a free quote today!';
        ...
        if (metaKeywords) {
            metaKeywords.setAttribute('content', 'web design Cape Town, website designer Cape Town, affordable web design Cape Town, web design Cape Town CBD, web design Sea Point, web design Camps Bay, web design Rondebosch, web design Claremont, web design Constantia, web design Table View, web design Blouberg, web design Hout Bay, web design Muizenberg');
        } else {
            metaKeywords = document.createElement('meta');
            metaKeywords.name = 'keywords';
            metaKeywords.content = 'web design Cape Town, website designer Cape Town, affordable web design Cape Town, web design Cape Town CBD, web design Sea Point, web design Camps Bay, web design Rondebosch, web design Claremont, web design Constantia, web design Table View, web design Blouberg, web design Hout Bay, web design Muizenberg';
        ...
        <>
            ...
            <section className="hero" style={{ padding: '80px 0' }}>
                <div className="container">
                    <div className="hero-content" style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
                        <h1>Web Design in Cape Town</h1>
                        <p>Professional websites for businesses in Cape Town, Sea Point, Camps Bay, Rondebosch, and across the Cape Peninsula. Starting from R1,499.</p>
            ...
            <section style={{ padding: '60px 0', textAlign: 'center' }}>
                <div className="container">
                    ...
                    <p style={{ marginBottom: '30px' }}>Contact us today for a free quote. Serving Cape Town CBD, Sea Point, Camps Bay, Rondebosch, and all of the Cape Peninsula.</p>
